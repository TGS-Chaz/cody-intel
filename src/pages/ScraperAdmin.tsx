...
const PLATFORMS: Platform[] = [
  ...
  },
  {
    ...
    source: "leafly",
    color: "#3BB143",
    description: "Discovers WA dispensaries via Leafly directory, fetches menus with full pagination",
  ...
  },
  {
    ...
    source: "posabit",
    color: "#5C6BC0",
    description: "Discovers POSaBit-powered WA stores, fetches menus via MCX API",
    action: "posabit-scan",
  },
  {
    id: "weedmaps",
    ...
    source: "weedmaps",
    color: "#F7931A",
    description: "Discovers WA dispensaries via Weedmaps directory, fetches complete menus",
